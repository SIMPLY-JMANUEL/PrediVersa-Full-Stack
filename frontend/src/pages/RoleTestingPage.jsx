...
import { refreshUserPermissions, clearRouteCache } from '../components/ProtectedRoute';
  ...
  const loginAsRole = async (role) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Limpiar cache y refrescar permisos
        clearRouteCache();
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-4 rounded-lg border mb-6">
        <h2 className="text-lg font-semibold mb-4">Probar Login con Diferentes Roles</h2>
          ...
          {testResults.success ? (
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2">
                Ahora puedes navegar por la aplicación para probar las rutas disponibles para el rol <strong>{testResults.role}</strong>
              </p>
            </div>
          ) : (
      ...
      <div className="bg-gray-50 p-4 rounded-lg mt-6">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm">
          ...
          <li>Una vez logueado, navega por las diferentes rutas usando la URL</li>
          <li>Verifica que solo puedas acceder a las rutas permitidas para tu rol</li>
          <li>Prueba rutas como: /admin, /teacher, /student, /parent, /moderator</li>
          <li>Las rutas no permitidas te redirigirán automáticamente a /login</li>
        </ol>
        
        <div className="mt-4">
          <h4 className="font-medium mb-2">Rutas esperadas por rol:</h4>
          <ul className="text-xs space-y-1">
            <li><strong>Admin:</strong> Todas las rutas</li>
            <li><strong>Teacher:</strong> /dashboard, /teacher, /profile, /courses</li>
            <li><strong>Student:</strong> /dashboard, /student, /profile, /courses</li>
            <li><strong>Parent:</strong> /dashboard, /parent, /profile</li>
            <li><strong>Moderator:</strong> /dashboard, /moderator, /profile</li>
          </ul>
        </div>
      </div>
