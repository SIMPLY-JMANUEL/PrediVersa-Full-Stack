...
function ParentDashboard() {
  ...
  // Estados para gestión familiar
  const [childSearch, setChildSearch] = useState('');
  const [messageSearch, setMessageSearch] = useState('');
  const [reportSearch, setReportSearch] = useState('');
  
  // Datos del padre de familia desde localStorage
  const userData = {
    name: localStorage.getItem('nombre') || 'Padre/Madre de Familia',
    lastName: localStorage.getItem('apellido') || '',
    role: 'Padre de Familia',
    documentType: 'DNI',
    documentNumber: '12345678',
    email: 'padre@prediversa.com',
    phone: '321456789',
    address: 'Calle 123, Ciudad',
    photo: '',
    children: [
      { name: 'Ana María', grade: '6°A', status: 'Activo' },
      { name: 'Carlos', grade: '8°B', status: 'Activo' }
    ]
  };

  // Estado centralizado del perfil padre
  const [parentProfileState, setParentProfileState] = useState(userData);
  // Estado para la foto de perfil del padre
  ...
  const handleSettingsSave = (newProfile) => {
    setParentProfileState((prev) => ({ ...prev, ...newProfile }));
    if (newProfile.photo) {
  ...
  const handleProfilePhotoChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setParentProfileState((prev) => ({ ...prev, photo: reader.result }));
      };
        ...
        return (
          <section style={{
            ...
            <h3 style={{
              ...
              <i className="fas fa-chart-line" style={{ marginRight: 12, color: '#1976d2' }}></i>
              ...
              {userData.children.map((child, index) => (
                <div key={index} style={{
                  ...
                  <div style={{ marginBottom: 8 }}>
                    <span style={{ ...unifiedStyles.label, marginBottom: 0 }}>Estudiante:</span>
                  ...
                  <div style={{ marginBottom: 8 }}>
                    ...
                    <span style={{ marginLeft: 8 }}>{child.grade}</span>
                  </div>
                  <div>
                    <span style={{ ...unifiedStyles.label, marginBottom: 0 }}>Estado:</span>
                    <span style={{ 
                      marginLeft: 8,
                      background: '#4caf50',
                      color: '#fff',
        ...
        return (
          <section style={{
            ...
            <h3 style={{
              ...
              <i className="fas fa-comments" style={{ marginRight: 12, color: '#4caf50' }}></i>
            ...
            <div style={{
              ...
              <div style={{ marginBottom: 12 }}>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, fontSize: unifiedTypography.fontSize.small }}>
                    Recordatorio: Reunión de padres el próximo viernes a las 3:00 PM.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ marginBottom: 16 }}>
                <label style={unifiedStyles.label}>Para:</label>
                <select style={unifiedStyles.input}>
                  <option>Seleccionar destinatario</option>
                  <option>Prof. García - Matemáticas</option>
                  <option>Prof. López - Español</option>
              ...
              <div style={{ marginBottom: 16 }}>
                <label style={unifiedStyles.label}>Asunto:</label>
                <input 
                  type="text" 
                  style={unifiedStyles.input}
                  placeholder="Escriba el asunto del mensaje"
                />
              </div>
              
              <div style={{ marginBottom: 16 }}>
                <label style={unifiedStyles.label}>Mensaje:</label>
                <textarea 
                  style={{
                    ...unifiedStyles.input,
                    height: 100,
  ...
  return (
    <div className="parent-dashboard-html">
      <header className="header-main-html">
        <div className="header-logo-title-html">
          ...
          <span className="header-title-html">Panel del Padre/Madre</span>
        </div>
      ...
      <main style={{ 
        ...
        <section style={{
          ...
          <div>
            <h1 style={{ 
              ...
              <i className="fas fa-home" style={{ marginRight: 16, fontSize: 36, color: '#1976d2' }}></i>
            ...
            <p style={{
              ...
              Acompaña el crecimiento académico de tu hijo(a) con herramientas personalizadas.
            </p>
          </div>
          <div style={{
            ...
            <i className="fas fa-child" style={{ fontSize: 32, color: '#fff' }}></i>
          </div>
        </section>
        ...
        <nav style={{
          ...
          <div style={{
            ...
            {['seguimiento', 'comunicacion'].map((tab) => (
              <button
                key={tab}
        ...
        <div style={{ display: 'flex', gap: 32 }}>
          ...
          <aside style={{
            ...
            <h3 style={{
              ...
              <i className="fas fa-user-graduate" style={{ marginRight: 12, color: '#1976d2' }}></i>
              Mi Hijo(a)
            </h3>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center', marginBottom: 16 }}>
                <div style={{
                  ...
                  <i className="fas fa-user" style={{ fontSize: 28, color: '#fff' }}></i>
                </div>
                <h4 style={{
                  fontFamily: unifiedTypography.fontFamily,
                  fontSize: unifiedTypography.fontSize.medium,
              ...
              <div style={{ borderTop: '1px solid #d0f0c0', paddingTop: 16 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  <span style={{ ...unifiedStyles.label, margin: 0 }}>Rendimiento:</span>
                  <span style={{ 
                    background: '#4caf50', 
                    color: '#fff', 
                    padding: '2px 8px', 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  <span style={{ ...unifiedStyles.label, margin: 0 }}>Asistencia:</span>
                  <span style={{ fontWeight: unifiedTypography.fontWeight.bold, color: '#2e7d32' }}>
                    95%
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ ...unifiedStyles.label, margin: 0 }}>Último reporte:</span>
                  <span style={{ color: '#666', fontSize: unifiedTypography.fontSize.small }}>
                    22/01/2024
                  </span>
                </div>
              </div>
      ...
      {showSettings && (
        <SettingsPanel
          ...
          userProfile={parentProfileState}
