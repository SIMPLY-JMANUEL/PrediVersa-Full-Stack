        ...
        <main className="main-html" style={{ 
          ...
          <aside className="dashboard-sidebar" style={{
            ...
            <section className="profile-image-container" style={{ height: 180, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
              <label htmlFor="profile-photo-upload" style={{ cursor: 'pointer', width: 120, height: 120, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
                {profilePhoto ? (
            ...
            <section className="user-info-container">
              <div className="info-row"><span><strong>Nombre:</strong> {adminProfileState.name} {adminProfileState.lastName}</span></div>
              <div className="info-row"><span><strong>Cargo:</strong> {adminProfileState.role}</span></div>
              <div className="info-row"><span><strong>Tipo documento:</strong> {adminProfileState.documentType}</span></div>
              <div className="info-row"><span><strong>Número documento:</strong> {adminProfileState.documentNumber}</span></div>
              <div className="info-row"><span><strong>Correo:</strong> {adminProfileState.email}</span></div>
              <div className="info-row"><span><strong>Teléfono:</strong> {adminProfileState.phone}</span></div>
              <div className="info-row"><span><strong>Dirección:</strong> {adminProfileState.address}</span></div>
            </section>
            <section className="system-status-container">
              <h3><i className="fas fa-tachometer-alt"></i> Estado del Sistema</h3>
              <div className="status-row"><i className="fas fa-bolt"></i><span><strong>Rendimiento:</strong> 98.5%</span></div>
              <div className="status-row"><i className="fas fa-shield-alt"></i><span><strong>Seguridad:</strong> Óptima</span></div>
              <div className="status-row"><i className="fas fa-microchip"></i><span><strong>Uso de Recursos:</strong> 67%</span></div>
            </section>
            <section className="stats-container">
              <h3><i className="fas fa-chart-bar"></i> Estadísticas</h3>
              <div className="stat-row"><i className="fas fa-users"></i><span><strong>Total Usuarios:</strong> 1,247</span></div>
              <div className="stat-row"><i className="fas fa-user-graduate"></i><span><strong>Estudiantes:</strong> 856</span></div>
              <div className="stat-row"><i className="fas fa-user-friends"></i><span><strong>Padres:</strong> 324</span></div>
              <div className="stat-row"><i className="fas fa-chalkboard-teacher"></i><span><strong>Profesores:</strong> 42</span></div>
              <div className="stat-row"><i className="fas fa-user-shield"></i><span><strong>Moderadores:</strong> 8</span></div>
              <div className="stat-row"><i className="fas fa-clipboard-list"></i><span><strong>Evaluaciones:</strong> 2,341</span></div>
              <div className="stat-row"><i className="fas fa-exclamation-triangle"></i><span><strong>Alertas:</strong> 12</span></div>
            </section>
          </aside>
          ...
          <section className="right-panel-html" style={{ 
            ...
            <section
              ...
              style={{
                background: 'linear-gradient(135deg, #fafdff 80%, #e8f5e8 100%)',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                ...
                <div>
                  <h2 style={{ color: '#4caf50', fontWeight: 800, fontSize: '1.25em', margin: 0, letterSpacing: 0.3 }}>Búsqueda de Usuario</h2>
              ...
              <div style={{ height: 1, background: '#c8e6c9', margin: '14px 0 20px 0', borderRadius: 2 }} />
              
              {/* Formulario de búsqueda */}
              <form onSubmit={handleUserSearch} style={{ display: 'flex', gap: 12, marginBottom: 20 }}>
                <input
                  type="text"
                  value={userSearch}
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.target.style.boxShadow = '0 4px 16px 0 rgba(76, 175, 80, 0.25)';
                  }}
                  onMouseLeave={(e) => {
              ...
              {userForm.encontrado && (
                <div style={{
                  ...
                  <div className="user-info-header" style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                    <div style={{ marginRight: 20 }}>
                      {userForm.foto ? (
                        ...
                        <div style={{
                          ...
                          <i className="fas fa-user" style={{ fontSize: 36, color: '#4caf50' }}></i>
                        </div>
                      )}
                    </div>
                    <div style={{ flex: 1 }}>
                      <h3 style={{ color: '#4caf50', fontWeight: 700, fontSize: '1.4em', margin: '0 0 8px 0' }}>
                        {userForm.nombreCompleto}
                      </h3>
                      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
                        <div style={{ color: '#666', fontSize: '1em' }}>
                          <strong style={{ color: '#4caf50' }}>Documento:</strong> {userForm.numeroDocumento}
                        </div>
                        <div style={{ color: '#666', fontSize: '1em' }}>
                          <strong style={{ color: '#4caf50' }}>Tipo:</strong> {userForm.tipoDocumento}
                        </div>
                        <div style={{ color: '#666', fontSize: '1em' }}>
                          <strong style={{ color: '#4caf50' }}>Fecha Nacimiento:</strong> {userForm.fechaNacimiento}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div style={{ background: '#f8f9fa', padding: '14px 16px', borderRadius: 10 }}>
                      <div style={{ color: '#4caf50', fontWeight: 600, fontSize: '0.95em', marginBottom: 8 }}>
                        <i className="fas fa-id-card" style={{ marginRight: 8 }}></i>
                        Información Personal
                      </div>
                      <div style={{ fontSize: '0.9em', color: '#666', lineHeight: 1.5 }}>
                        <div><strong>Edad:</strong> {userForm.edad} años</div>
                        <div><strong>Género:</strong> {userForm.sexoGenero}</div>
                        <div><strong>Estado Civil:</strong> {userForm.estadoCivil}</div>
                      </div>
                    </div>
                    ...
                    <div style={{ background: '#f8f9fa', padding: '14px 16px', borderRadius: 10 }}>
                      ...
                      <div style={{ fontSize: '0.9em', color: '#666', lineHeight: 1.5 }}>
                        <div><strong>Email:</strong> {userForm.correoElectronico}</div>
                        <div><strong>Teléfono:</strong> {userForm.telefonoUsuario}</div>
                        <div><strong>Dirección:</strong> {userForm.direccionResidencia}</div>
                      </div>
                    </div>
                    ...
                    <div style={{ background: '#f8f9fa', padding: '14px 16px', borderRadius: 10 }}>
                      ...
                      <div style={{ fontSize: '0.9em', color: '#666', lineHeight: 1.5 }}>
                        <div><strong>Grado/Cargo:</strong> {userForm.gradoCargo}</div>
                        <div><strong>Institución:</strong> {userForm.institucionEmpresa}</div>
                      </div>
                    </div>
                    ...
                    <div style={{ background: '#f8f9fa', padding: '14px 16px', borderRadius: 10 }}>
                      ...
                      <div style={{ fontSize: '0.9em', color: '#666', lineHeight: 1.5 }}>
                        <div><strong>EPS:</strong> {userForm.epsSeguroMedico}</div>
                        <div><strong>Antecedentes:</strong> {userForm.antecedentesMedicos}</div>
                        <div><strong>Condición Especial:</strong> {userForm.condicionEspecial}</div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div style={{ marginTop: 20, textAlign: 'center' }}>
                      <button
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.target.style.boxShadow = '0 6px 24px 0 rgba(25, 118, 210, 0.3)';
                        }}
                        onMouseLeave={(e) => {
                          e.target.style.transform = 'translateY(0)';
                          e.target.style.boxShadow = '0 4px 16px 0 rgba(25, 118, 210, 0.2)';
                        }}
                      >
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 20 }}>
                    <div style={{
                      ...
                      <i className="fas fa-user-cog" style={{ fontSize: 20 }}></i>
                    </div>
                    <div>
                      <h3 style={{ color: '#1976d2', fontWeight: 700, fontSize: '1.3em', margin: 0 }}>
                        Configuración de Usuario
                      </h3>
                      <div style={{ color: '#666', fontSize: '1em', marginTop: 4 }}>
                        Configura los parámetros finales para la creación del usuario
                      </div>
                    </div>
                  </div>
                  ...
                  {!userCreationData.confirmed ? (
                    <>
                      ...
                      <div style={{ background: '#f8f9fa', padding: '20px 24px', borderRadius: 12, marginBottom: 24 }}>
                        <h4 style={{ color: '#333', margin: '0 0 16px 0', fontSize: '1.15em', fontWeight: 600 }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 16 }}>
                          <div>
                            ...
                            <select
                              style={{
                                ...
                                fontSize: '1em',
                                background: '#fff',
                                color: userCreationData.status ? '#333' : '#999'
                              }}
                              value={userCreationData.status || ''}
                              onChange={(e) => setUserCreationData(prev => ({ ...prev, status: e.target.value }))}
                            >
                              <option value="" disabled style={{ color: '#999' }}>Seleccionar</option>
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => setUserCreationData(prev => ({ ...prev, role: e.target.value }))}
                            >
                              <option value="" disabled style={{ color: '#999' }}>Seleccionar</option>
                              <option value="estudiante">Estudiante</option>
                              <option value="padre">Padre/Madre/Acudiente</option>
                      ...
                      <div style={{ background: '#e3f2fd', padding: '20px 24px', borderRadius: 12, marginBottom: 24 }}>
                        <h4 style={{ color: '#1976d2', margin: '0 0 16px 0', fontSize: '1.15em', fontWeight: 600 }}>
                        ...
                        >
                          <div>
                            <div style={{ color: '#666', fontSize: '0.9em', marginBottom: 4 }}>Nombre de Usuario:</div>
                            <div style={{ 
                              background: '#fff', 
                              padding: '10px 14px', 
                              borderRadius: 6, 
                          ...
                          <div>
                            <div style={{ color: '#666', fontSize: '0.9em', marginBottom: 4 }}>Correo Electrónico:</div>
                            <div style={{ 
                              background: '#fff', 
                              padding: '10px 14px', 
                              borderRadius: 6, 
                          ...
                          <div>
                            <div style={{ color: '#666', fontSize: '0.9em', marginBottom: 4 }}>Contraseña Temporal:</div>
                            <div style={{ 
                              background: '#fff', 
                              padding: '10px 14px', 
                              borderRadius: 6, 
                              ...
                              <button
                                type="button"
                                onClick={() => setUserCreationData(prev => ({ ...prev, autoPassword: generateAutoPassword() }))}
                                style={{
                                  background: 'none',
                                  border: 'none',
                                  color: '#1976d2',
                      ...
                      <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <button
                          ...
                          onMouseEnter={(e) => {
                            e.target.style.transform = 'translateY(-2px)';
                            e.target.style.boxShadow = '0 6px 24px 0 rgba(76, 175, 80, 0.3)';
                          }}
                          onMouseLeave={(e) => {
                            e.target.style.transform = 'translateY(0)';
                            e.target.style.boxShadow = '0 4px 16px 0 rgba(76, 175, 80, 0.2)';
                          }}
                        >
                    ...
                    <div style={{ textAlign: 'center', padding: '20px 0' }}>
                      ...
                      <h3 style={{ color: '#4caf50', margin: '0 0 12px 0', fontSize: '1.4em' }}>
                        ¡Usuario Creado Exitosamente!
                      </h3>
                      <p style={{ color: '#666', fontSize: '1.1em', margin: '0 0 20px 0' }}>
                        El usuario <strong>{userForm.nombreCompleto}</strong> ha sido creado con éxito.
                      </p>
                      <div style={{ 
                        background: '#f8f9fa', 
                        padding: '16px 20px', 
                        ...
                        <div style={{ marginBottom: 8 }}>
                          <strong>Usuario:</strong> {userCreationData.autoUsername}
                        </div>
                        <div style={{ marginBottom: 8 }}>
            ...
            {activeTab === 'crearusuario' && (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                  ...
                  <div>
                    <h2 style={{ color: '#1976d2', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Registro de usuario</h2>
                    <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                      Diligencia todos los campos obligatorios para crear un nuevo usuario.
                    </div>
                  </div>
                </div>
            ...
            <div className="tab-content-container" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, overflowY: 'auto' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    <div style={{
                      ...
                      <i className="fas fa-exclamation-triangle" style={{ fontSize: 22 }}></i>
                    </div>
                    <div>
                      <h2 style={{ color: '#ff9800', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Gestión de Alerta</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Gestión de Alerta Recibida - Administra y da seguimiento a alertas críticas y eventos importantes.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#ffe0b2', margin: '18px 0 24px 0', borderRadius: 2 }} />
                  <AlertarForm fieldsetStyle={fieldsetStyle} legendStyle={legendStyle} unifiedStyles={unifiedStyles} />
                </section>
              )}
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    <div style={{
                      ...
                      <i className="fas fa-chart-line" style={{ fontSize: 22 }}></i>
                    </div>
                    <div>
                      <h2 style={{ color: '#4caf50', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Generación de Reportes</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Crea y exporta reportes detallados sobre el estado y progreso del sistema.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#c8e6c9', margin: '18px 0 24px 0', borderRadius: 2 }} />
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    <div style={{
                      ...
                      <i className="fas fa-user-md" style={{ fontSize: 22 }}></i>
                    </div>
                    <div>
                      <h2 style={{ color: '#9c27b0', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Remisión de Atención</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Gestiona remisiones médicas y derivaciones de atención especializada.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#e1bee7', margin: '18px 0 24px 0', borderRadius: 2 }} />
                  <RemisionForm fieldsetStyle={fieldsetStyle} legendStyle={legendStyle} unifiedStyles={unifiedStyles} />
                </section>
              )}
              ...
              {activeTab === 'seguimiento' && (
                <section
                  className="premium-tab-section"
                  style={{
                    background: 'linear-gradient(135deg, #fafdff 80%, #e0f2f1 100%)',
                    border: '1.5px solid #d0d7e6',
                    borderRadius: 18,
                    padding: '32px 32px 28px 32px',
                    marginBottom: 32,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    <div style={{
                      ...
                      <i className="fas fa-tasks" style={{ fontSize: 22 }}></i>
                    </div>
                    <div>
                      <h2 style={{ color: '#009688', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Panel de Seguimiento</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Monitorea el progreso y estado de casos, evaluaciones y procesos.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#b2dfdb', margin: '18px 0 24px 0', borderRadius: 2 }} />
              ...
              {activeTab === 'pqradmin' && (
                <section
                  className="premium-tab-section"
                  style={{
                    background: 'linear-gradient(135deg, #fafdff 80%, #fff8e1 100%)',
                    border: '1.5px solid #d0d7e6',
                    borderRadius: 18,
                    padding: '32px 32px 28px 32px',
                    marginBottom: 32,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    <div style={{
                      ...
                      <i className="fas fa-clipboard-list" style={{ fontSize: 22 }}></i>
                    </div>
                    <div>
                      <h2 style={{ color: '#f57c00', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Administrador de PQR</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Gestiona peticiones, quejas, reclamos y solicitudes de los usuarios.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#ffecb3', margin: '18px 0 24px 0', borderRadius: 2 }} />
              ...
              {activeTab === 'pqrseguimiento' && (
                <section
                  className="premium-tab-section"
                  style={{
                    background: 'linear-gradient(135deg, #fafdff 80%, #e8eaf6 100%)',
                    border: '1.5px solid #d0d7e6',
                    borderRadius: 18,
                    padding: '32px 32px 28px 32px',
                    marginBottom: 32,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    ...
                    <div>
                      <h2 style={{ color: '#3f51b5', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Seguimiento PQR</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Rastrea el estado y progreso de las solicitudes PQR en el sistema.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#c5cae9', margin: '18px 0 24px 0', borderRadius: 2 }} />
                  <PqrSeguimientoForm fieldsetStyle={fieldsetStyle} legendStyle={legendStyle} unifiedStyles={unifiedStyles} />
                </section>
              )}
              ...
              {activeTab === 'soporte' && (
                <section
                  className="premium-tab-section"
                  style={{
                    background: 'linear-gradient(135deg, #fafdff 80%, #fce4ec 100%)',
                    border: '1.5px solid #d0d7e6',
                    borderRadius: 18,
                    padding: '32px 32px 28px 32px',
                    marginBottom: 32,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
                    <div style={{
                      ...
                      <i className="fas fa-headset" style={{ fontSize: 22 }}></i>
                    </div>
                    <div>
                      <h2 style={{ color: '#e91e63', fontWeight: 800, fontSize: '1.35em', margin: 0, letterSpacing: 0.5 }}>Comunicación y Soporte</h2>
                      <div style={{ color: '#4a4a4a', fontSize: '1.07em', marginTop: 2, fontWeight: 400 }}>
                        Centro de comunicación y asistencia técnica para usuarios del sistema.
                      </div>
                    </div>
                  </div>
                  <div style={{ height: 1, background: '#f8bbd9', margin: '18px 0 24px 0', borderRadius: 2 }} />
