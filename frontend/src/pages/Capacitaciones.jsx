  ...
  const capacitaciones = [
    {
      ...
      description: "Capacitación integral para identificar y prevenir riesgos en entornos educativos y empresariales mediante estrategias científicamente respaldadas.",
      ...
      impact: "Reducción del 32% en niveles de estrés y mejora significativa del clima laboral",
      additionalInfo: {
        title: "Metodología Integral",
        content: "Nuestro programa combina técnicas de neurociencia aplicada, psicología positiva y tecnología wearable para crear un ecosistema completo de prevención. Incluye sesiones presenciales, plataforma digital 24/7 y seguimiento personalizado con profesionales especializados."
      }
    },
    {
      id: 2,
      title: "Bienestar Laboral Integral",
      description: "Herramientas y estrategias avanzadas para promover el bienestar organizacional y la salud mental en el entorno de trabajo moderno.",
      ...
      impact: "Incremento del 21% en productividad y 35% en satisfacción laboral",
      additionalInfo: {
        title: "Transformación Cultural",
        content: "Implementamos un cambio cultural profundo que abarca desde políticas organizacionales hasta prácticas diarias. Nuestro enfoque incluye coaching ejecutivo, talleres de mindfulness corporativo y creación de espacios de bienestar físico y mental en el lugar de trabajo."
      }
    },
    {
      id: 3,
      title: "Gestión Avanzada del Estrés",
      description: "Técnicas innovadoras y basadas en evidencia para la gestión del estrés organizacional y la mejora del clima laboral sostenible.",
      ...
      impact: "Reducción del 40% en licencias por estrés y mejora del 28% en rendimiento",
      additionalInfo: {
        title: "Ciencia del Estrés",
        content: "Utilizamos las últimas investigaciones en neuroplasticidad y biofeedback para crear programas personalizados. Cada participante recibe un plan adaptado basado en su perfil de estrés, medido a través de biomarcadores y tecnología avanzada de monitoreo continuo."
      }
    }
  ];
        ...
        <div className="container">
          <div className="cap-hero-content animate-fade-in-up">
            ...
            <p className="cap-hero-subtitle">
              Programas especializados de formación y prevención en riesgos psicosociales para instituciones educativas y empresas modernas
            </p>
          ...
          <div className="cap-content-container">
            <div className="cap-grid">
              {capacitaciones.map((capacitacion, index) => (
                <article key={capacitacion.id} className="cap-card animate-stagger hover-lift">
                  <div className="cap-image-container">
                    ...
                    <div className="cap-image-overlay">
                      <div className="cap-overlay-icon">
                        <i className={capacitacion.icon} aria-hidden="true"></i>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="cap-card-content">
                    ...
                    <p className="cap-card-description">{capacitacion.description}</p>
                    ...
                    <div className="cap-button-group">
                      ...
                      >
                        <i className={`fas fa-${expandedCard === capacitacion.id ? 'minus' : 'plus'}`} aria-hidden="true"></i>
                        {expandedCard === capacitacion.id ? 'Ocultar detalles' : 'Ver más detalles'}
                      </button>
                      <a href="#contacto" className="btn-regresar cap-btn cap-btn-secondary">
                        <i className="fas fa-envelope" aria-hidden="true"></i>
                        Solicitar info
                      </a>
                    </div>
                    
                    <div className={`cap-expandable-info ${expandedCard === capacitacion.id ? 'show' : ''}`}>
                      {expandedCard === capacitacion.id && (
                        <div className="cap-info-content">
                          <h4 className="cap-info-title">{capacitacion.additionalInfo.title}</h4>
