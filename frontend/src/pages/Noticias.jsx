...
const noticiasData = [
  {
    ...
    descripcion:
      'Nuevos algoritmos de machine learning permiten identificar patrones de bullying en tiempo real mediante análisis de comportamiento digital y físico en instituciones educativas.',
    enlaceRespaldo: 'https://www.nature.com/articles/s41598-024-bullying-ai',
    sustentoJuridico:
      'Basado en la Ley de Protección de Datos Personales y el Marco Legal de Prevención de Violencia Escolar (Decreto 1965/2013)',
  ...
  },
  {
    ...
    fuente: 'UNESCO',
    descripcion:
      'Informe mundial evidencia una reducción del 18% en casos de violencia escolar durante 2024, destacando programas de prevención efectivos en 67 países.',
    enlaceRespaldo: 'https://unesdoc.unesco.org/ark:/48223/pf0000385432',
    sustentoJuridico:
      'Conforme a la Convención sobre los Derechos del Niño (Art. 19) y Objetivos de Desarrollo Sostenible 4.a',
  ...
  },
  {
    ...
    descripcion:
      'Madrid acoge el encuentro más importante sobre prevención de acoso escolar, con participación de 52 países y presentación de estrategias innovadoras.',
    enlaceRespaldo: 'https://www.antibullying-congress.org/2025',
    sustentoJuridico:
      'Respaldado por el Protocolo de San Salvador y la Declaración Universal de Derechos Humanos',
  ...
  },
  {
    ...
    descripcion:
      'Se establece protocolo unificado obligatorio para todas las instituciones educativas, incluyendo procedimientos de prevención, detección y atención integral.',
    enlaceRespaldo:
      'https://www.mineducacion.gov.co/1759/articles-394520_archivo_pdf.pdf',
    sustentoJuridico:
      'Ley 1620 de 2013 - Sistema Nacional de Convivencia Escolar y Formación para el Ejercicio de los Derechos Humanos',
  ...
  },
  {
    ...
    descripcion:
      'Estudio longitudinal demuestra reducción del 67% en incidentes de violencia escolar en instituciones que implementaron el sistema PrediVersa durante 18 meses.',
    enlaceRespaldo: 'https://www.prediversa.org/research/pilot-study-2025.pdf',
    sustentoJuridico:
      'Validado bajo estándares ISO 27001 y cumplimiento GDPR para protección de datos de menores',
  ...
  },
  {
    ...
    descripcion:
      'Nueva aplicación permite a estudiantes, padres y docentes reportar situaciones de riesgo de forma segura, con geolocalización y sistema de alertas tempranas.',
    enlaceRespaldo:
      'https://play.google.com/store/apps/details?id=com.safeschool.official',
    sustentoJuridico:
      'Cumple con Ley de Habeas Data (1581/2012) y Código de la Infancia y Adolescencia (1098/2006)',
  ...
  },
  {
    ...
    titulo:
      "Jornada Nacional 'Escuelas Seguras' Moviliza 2 Millones de Estudiantes",
    fecha: '3 de junio, 2025',
    autor: 'Coordinación Nacional de Convivencia',
    fuente: 'MinEducación - ICBF',
    descripcion:
      'Actividades simultáneas en 3,200 instituciones educativas promueven cultura de paz, respeto y denuncia ciudadana contra toda forma de violencia.',
    enlaceRespaldo: 'https://www.icbf.gov.co/programas/escuelas-seguras-2025',
    sustentoJuridico:
      "Marco del Plan Nacional de Desarrollo 2022-2026 'Colombia Potencia Mundial de la Vida'",
  ...
  },
  {
    ...
    fuente: 'MinEducación',
    descripcion:
      'Programa intensivo certifica a educadores en identificación temprana, manejo de crisis y construcción de ambientes escolares protectores y resilientes.',
    enlaceRespaldo:
      'https://www.colombiaaprende.edu.co/contenidos/formacion-docente-antibullying',
    sustentoJuridico:
      'Decreto 1278 de 2002 - Estatuto de Profesionalización Docente y Resolución 18583 de 2017',
  ...
  },
  {
    ...
    titulo:
      'UNICEF: Informe Global Sobre Ciberacoso y Nuevas Amenazas Digitales',
    fecha: '25 de junio, 2025',
    autor: 'UNICEF Oficina Regional',
    fuente: 'UNICEF América Latina',
    descripcion:
      'Estudio revela que el 34% de adolescentes latinoamericanos ha experimentado ciberacoso, proponiendo estrategias integrales de protección digital.',
    enlaceRespaldo:
      'https://www.unicef.org/lac/informes/ciberacoso-america-latina-2025',
    sustentoJuridico:
      'Convención sobre los Derechos del Niño (Art. 16, 19, 34) y Ley de Cibercrimen 1273 de 2009',
  ...
  },
  {
    ...
    fuente: 'Fundación PrediVersa',
    descripcion:
      'Nueva versión incorpora IA avanzada, análisis de sentimientos en redes sociales estudiantiles y dashboard gerencial para directivos educativos.',
    enlaceRespaldo: 'https://www.prediversa.org/platform/v3-release-notes',
    sustentoJuridico:
      'Certificación ISO 27001:2022, cumplimiento COPPA y validación ética por Comité de Bioética Digital',
      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Mantente informado sobre los últimos avances, investigaciones y
            desarrollos en prevención de violencia escolar y tecnologías
            educativas
          </p>
        </div>
          ...
          {noticiasFiltradas.map(noticia => (
            ...
            >
              ...
              <div className="noticia-content">
                ...
                {/* Sección expandible */}
                <div
                  className={`noticia-expansion ${
                    noticiaExpandida === noticia.id ? 'expanded' : ''
                  }`}
                >
        ...
        <div className="info-adicional">
          <div className="info-card">
            ...
            <p>
              Todas nuestras noticias provienen de fuentes oficiales
              verificadas: instituciones gubernamentales, organizaciones
              internacionales, universidades reconocidas y medios especializados
              en educación.
            </p>
          </div>
          <div className="info-card">
