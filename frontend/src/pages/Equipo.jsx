  ...
  const teamMembers = [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=800&h=800&fit=crop&crop=face&auto=format&q=80',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=800&h=800&fit=crop&crop=face&auto=format&q=80',
        ...
        <div className="container">
          <div className="equipo-hero-content animate-fade-in-up">
            ...
            <p className="equipo-hero-subtitle">
              Profesionales especializados unidos por la misión de transformar
              la educación a través de la prevención inteligente del bullying
              escolar
            </p>
            <div className="equipo-divider" />
          </div>
        </div>
      </section>
          ...
          <div className="equipo-content-container">
            <div className="equipo-grid">
              {teamMembers.map(member => (
                <article
                  key={member.id}
                  className="equipo-member-card animate-stagger hover-lift"
                >
                  <div className="equipo-image-container">
                    <img
                      ...
                      onError={e => {
                        e.target.src =
                          'https://via.placeholder.com/800x800/e2e8f0/64748b?text=' +
                  ...
                  <div className="equipo-member-content">
                    <header className="equipo-member-header">
                      ...
                      <p className="equipo-member-specialty">
                        {member.specialty}
                      </p>
                    </header>
