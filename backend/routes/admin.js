...
router.put('/usuarios/:id', jwtRequired, roleRequired('admin'), (req, res) => {
  ...
  if (!usuario) {
    return sendResponse(res, { success: false, msg: 'Usuario no encontrado', status: 404 });
  }
...
router.delete('/usuarios/:id', jwtRequired, roleRequired('admin'), (req, res) => {
...
router.delete('/recursos/:id', jwtRequired, roleRequired('admin'), (req, res) => {
